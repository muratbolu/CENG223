...
\end{align*}
%Before these four proofs I will have to prove that $\log_2{x} \leq \frac{x}{51}, \; \forall x \geq 500$, $\log_2{x} \leq x, \; \forall x \geq 1$, and $\log_2{x} \leq \sqrt{x}, \; \forall x \geq 16$. All of them are similar.
\paragraph{c)}
\begin{gather*}
